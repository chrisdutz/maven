...
/**
 * Implementation of a ScopeDeriver that uses a list of LanguageSupport to
 * allow scope derivation for a list of languages.
 */
public class MultiLanguageScopeDeriver extends ConflictResolver.ScopeDeriver
{
    ...
    public void deriveScope( ConflictResolver.ScopeContext context ) throws RepositoryException
    {
        ...
        {
            languageSupport.getScopeDeriver().deriveScope( context );
        }
    }
